...
- ## Caution
    - 주의! 원서에 있는 코드랑 다른 부분이 존재합니다!
      ...
      - 코드변경
        엘리트 선택이 된 개체를 제외 하고 선택을 하기 위해 선택을 먼저 한 후 선택된 개체를 제거하는 부분을 추가함
        127줄 -> 120줄 이동
        ```python
...
- ## Toolbox
    ...
    # 개체 집단에 대해 교차 연산을 병렬로 수행하는 함수 ( 짝 지어주기 )
    ...
    # 두 부모 유전자를 섞어 자식 유전자 두 개를 생성하는 함수
