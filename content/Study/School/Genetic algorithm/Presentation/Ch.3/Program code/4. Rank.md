...
- ## Population create
    ...
    - Result<br>
         <img src="https://github.com/user-attachments/assets/89b35226-9df4-4374-8b9c-4379d7906485" width="500" height="500"/>
...
- ## Visualization
    ...
    - Result<br>
       <img src="https://github.com/user-attachments/assets/33dbb145-78f7-411c-ad51-d6fc642ce463" width="500" height="500"/>
       <img src="https://github.com/user-attachments/assets/8319d13b-1623-4d60-bbc2-a0c0ac33134f" width="500" height="500"/>


- ## Pros, Cons
    | **장점** | **단점** |
    |-----------------|-----------------|
    | 다양성 유지에 좋음 | 매 세대마다 순위 정렬로 인한 추가 비용 |
    | 조기 수렴 위험 완화 | 적합도 값의 절대적 차이 무시 |
    | 안정적인 선택 압력 유지 | 적합도 동점 처리의 복잡성 존재 |
    | 스케일링 문제 완화 |  |
