...
- ## Population create
    ...
    - ch3
        - selection_population
            ...
            ```
    - Result<br>
         <img src="https://github.com/user-attachments/assets/aef8cbfa-74f6-4d7b-8081-0549f27842fa" width="400" height="50"/>
...
- ## Visualization
    - Bar graph ver.
        ...
        - Result<br>
           <img src="https://github.com/user-attachments/assets/d919c5c2-143e-479a-8fcf-8255424a0b2b" width="500" height="380"/>
    ...
    - Pie graph ver.
        ...
        - Result<br>
           <img src="https://github.com/user-attachments/assets/094e4100-be34-4837-a176-453e897896ac" width="500" height="380"/>
...
- ## Pros, Cons
    | **장점** | **단점** |
    |-----------------|-----------------|
    | 직관적이고 구현이 쉬움 | 조기 수렴 위험이 매우 높음 |
    | 적합도에 따라 직접적 선택 가능 | 적합도 값에 민감 |
    | 빠른 수렴 가능성 | 스케일링 문제 발생 가능성 |
    |  | 낮은 적합도의 개체 선택 어려움 |
