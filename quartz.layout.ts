  ...
  afterBody: [
    Component.Comments({
      ...
      options: {
        ...
        lightTheme: "custom-light", // corresponds to light-theme.css in quartz/static/giscus/
        darkTheme: "custom-dark", // corresponds to dark-theme.css quartz/static/giscus/
      }
    }),
  ],
